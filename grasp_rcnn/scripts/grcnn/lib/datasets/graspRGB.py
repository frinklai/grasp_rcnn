...
class graspRGB(imdb):
    ...
    def _load_image_set_index(self):
        ...
        print('_load_image_set_index = ', self._image_set)
    ...
    def selective_search_roidb(self):
        ...
        if self._image_set != 'test':
            print('== call _load_selective_search_roidb from train: ')
            gt_roidb = self.gt_roidb()
            ss_roidb = self._load_selective_search_roidb(gt_roidb)
            roidb = imdb.merge_roidbs(gt_roidb, ss_roidb)
        else:
            print('== call _load_selective_search_roidb from test: ')
    ...
    def selective_search_IJCV_roidb(self):
        ...
        print('--- in selective_search_IJCV_roidb')
        gt_roidb = self.gt_roidb()
    ...
    def _load_graspRGB_annotation(self, index):
        ...
        """
        # tmp1 = index.split('C:\\Users\\YCLai\\Documents\\GitHub\\grasp_multiObject_multiGrasp\\data\\scripts\\cgd_info\\datasetCropped320_rgd/')
        # index = tmp1[1].replace('.png','')
        # index
        ...
        #         data = f.readlines()
        # except:
        #     filename = os.path.join(self._data_path, 'ImageSets/', index + '.txt')
        #     print('Loading: {}'.format(filename))
        #     with open(filename) as f:
        #         data = f.readlines()
